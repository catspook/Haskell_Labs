...
> prob1Test2 = subset [1,2] [1,2] == True
> prob1Test3 = subset [1,2] [5,6,7]  == False
> prob1Test4 = subset [] [1,2] == True
> prob1Test5 = subset [1,3] [1,2] == False 
> prob1 = do
>           putStrLn ("subset [1,2,3] [1,2,3,4] = " ++ show (subset [1,2,3] [1,2,3,4]))
>           putStrLn ("subset [1,2] [1,2]  = " ++ show (subset [1,2] [1,2] ))
>           putStrLn ("subset [1,2] [5,6,7] = " ++ show (subset [1,2] [5,6,7]))
>           putStrLn ("subset [] [1,2]  = " ++ show (subset [] [1,2] ))
>           putStrLn ("subset [1,3] [1,2]  = " ++ show (subset [1,3] [1,2] ))
...
Put elem and notElem inside `elem` and `notElem` to put in middle of stuff

> dupOut :: Eq a => [a] -> [a]
> dupOut [] = []
> dupOut (x:xs) 
>   |notElem x xs = x: (dupOut xs)
>   |otherwise = dupOut xs 
...
> insertSecondLast v [] = [v]
> insertSecondLast v (x:[]) = v:x:[] 
> insertSecondLast v (x:xs) = x: insertSecondLast v xs
